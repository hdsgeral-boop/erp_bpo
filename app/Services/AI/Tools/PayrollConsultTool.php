...
class PayrollConsultTool implements ToolInterface
{
    public function getName(): string { return 'payroll_consult'; }
    public function getDescription(): string { return 'Consult data related to Payroll'; }

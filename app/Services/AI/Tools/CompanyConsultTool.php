...
class CompanyConsultTool implements ToolInterface
{
    public function getName(): string { return 'company_consult'; }
    public function getDescription(): string { return 'Consult data related to Company'; }

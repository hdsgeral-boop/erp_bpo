...
class PurchaseConsultTool implements ToolInterface
{
    public function getName(): string { return 'purchase_consult'; }
    public function getDescription(): string { return 'Consult data related to Purchase'; }

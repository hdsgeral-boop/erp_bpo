...
<head>
    ...
    <title>Recuperação de Palavra-passe - ERP_CONSULT</title>
    ...
    <style>
        ...
        .alert-success { background: #f0fdf4; border-left: 4px solid #22c55e; color: #15803d; padding: 1rem; border-radius: 6px; text-align: left; font-size: 0.875rem; margin-bottom: 1.5rem; font-weight: 500;}
...
<body>
    ...
    <div class="login-card">
        ...
        <h1 class="login-title">Recuperação de Acesso</h1>
        <p class="login-subtitle">Insira o seu e-mail para receber um link de redefinição.</p>
        ...
        <form method="POST" action="{{ route('password.email') }}">
            ...
            <div style="margin-top: 1.5rem;">
                <a href="{{ route('login') }}" style="font-size: 0.875rem; color: #4f46e5; text-decoration: none; font-weight: 600; transition: color 0.2s;"><i class="fas fa-arrow-left"></i> Voltar ao Login</a>
            </div>
        </form>
    </div>
</body>

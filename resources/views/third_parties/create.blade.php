...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="fw-bold mb-0 text-dark"><i class="fas fa-building text-primary me-2"></i>Nova Entidade</h2>
            <p class="text-muted mb-0">Registar um novo Cliente ou Fornecedor no sistema.</p>
        </div>
        ...
        <form action="{{ route('entidades.store') }}" method="POST">
            ...
            <div class="row g-4 mb-4">
                ...
                <div class="col-md-3">
                    ...
                    <select name="type" class="form-select" required>
                        <option value="CUSTOMER" {{ old('type') == 'CUSTOMER' ? 'selected' : '' }}>Cliente</option>
            ...
            <div class="row g-4 mb-4">
                <div class="col-md-6">
                    ...
                    <input type="text" name="address" class="form-control" placeholder="Morada completa" value="{{ old('address') }}">
                </div>
                <div class="col-md-3">
                    <label class="form-label">Email</label>
                    <input type="email" name="email" class="form-control" placeholder="contacto@empresa.com" value="{{ old('email') }}">
                </div>
                <div class="col-md-3">
                    <label class="form-label">Telefone</label>
                    <input type="text" name="phone" class="form-control" placeholder="+244 ..." value="{{ old('phone') }}">
                </div>
                <div class="col-md-4">
                    <label class="form-label">Conta Contabilística</label>
                    <input type="text" name="account_code" class="form-control" placeholder="Ex: 31.1.2.1" value="{{ old('account_code') }}">
                </div>
            </div>

...
<head>
    ...
    <title>Módulo Recursos Humanos & IRT - Consulvolt Soluções</title>
    <meta name="description" content="Módulo de Recursos Humanos e Processamento Salarial do ERP Consulvolt em Angola. Cálculo exato de IRT (tabela 2026), INSS (3%/8%), recibos PDF e ficheiros bancários PS2.">
...
<body>
    ...
    <section class="hero-banner-page">
        <div class="container">
            <span class="badge bg-primary px-3 py-2 rounded-pill mb-3" style="background-color: #0058E6 !important; font-size: 0.85rem;"><i class="fas fa-users-cog me-1"></i> Tabela IRT 2026 & Segurança Social</span>
            <h1 class="fw-extrabold display-4 mb-3 text-white">Recursos Humanos & Salários</h1>
            <p class="lead text-slate-300 fs-5 mb-0" style="max-width: 750px;">
                Gestão completa de colaboradores, processamento de vencimentos, cálculo automático do Imposto sobre o Rendimento do Trabalho (IRT) e INSS em Angola.
            </p>
        </div>
    </section>
    ...
    <section class="py-5" style="background: #ffffff;">
        <div class="container py-4">
            <div class="row g-5 align-items-center">
                <div class="col-lg-7">
                    <span class="text-primary fw-bold text-uppercase fs-8" style="color: #0058E6 !important;">Gestão de Capital Humano</span>
                    <h2 class="fw-extrabold text-dark fs-2 mb-4 mt-2">Processamento Salarial sem Complicações</h2>
                    <p class="text-secondary fs-6 mb-4" style="line-height: 1.7;">
                        O módulo de <strong>Recursos Humanos</strong> do ERP Consulvolt automatiza a gestão de pessoal e o cálculo de folha de pagamento de acordo com a legislação laboral e fiscal de Angola.
                    </p>

                    <div class="row g-4 mb-4">
                        <div class="col-sm-6">
                            <div class="p-3 bg-light rounded-3 border">
                                <h6 class="fw-bold text-dark mb-2"><i class="fas fa-calculator text-primary me-2" style="color: #0058E6 !important;"></i> Tabela IRT 2026 Progressiva</h6>
                                <p class="text-muted fs-7 mb-0">Cálculo preciso dos escalões de retenção na fonte do IRT.</p>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="p-3 bg-light rounded-3 border">
                                <h6 class="fw-bold text-dark mb-2"><i class="fas fa-shield-alt text-primary me-2" style="color: #0058E6 !important;"></i> INSS (3% + 8%)</h6>
                                <p class="text-muted fs-7 mb-0">Separação exata do desconto do trabalhador e encargo patronal.</p>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="p-3 bg-light rounded-3 border">
                                <h6 class="fw-bold text-dark mb-2"><i class="fas fa-file-pdf text-primary me-2" style="color: #0058E6 !important;"></i> Recibos em PDF e PS2</h6>
                                <p class="text-muted fs-7 mb-0">Emissão em lote de recibos e ficheiros para transferência bancária.</p>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="p-3 bg-light rounded-3 border">
                                <h6 class="fw-bold text-dark mb-2"><i class="fas fa-calendar-check text-primary me-2" style="color: #0058E6 !important;"></i> Assiduidade e Férias</h6>
                                <p class="text-muted fs-7 mb-0">Controlo rigoroso de faltas, horas extraordinárias e subsídios.</p>
                            </div>
                        </div>
                    </div>

                    <a href="{{ route('register') }}" class="btn btn-blue btn-lg px-4 py-3">
                        <i class="fas fa-rocket me-2"></i> Experimentar Módulo de RH
                    </a>
                </div>
                ...
                <div class="col-lg-5">
                    <div class="card border-0 shadow-lg overflow-hidden" style="border-radius: 20px;">
                        <div class="card-body p-4 text-white" style="background: #090d16;">
                            <h5 class="fw-bold mb-3">Vantagens para o departamento de RH</h5>
                            <ul class="list-unstyled fs-7 text-slate-300 mb-0">
                                <li class="mb-3"><i class="fas fa-check text-primary me-2" style="color: #60a5fa !important;"></i> Cadastro completo de colaboradores e contratos</li>
                                <li class="mb-3"><i class="fas fa-check text-primary me-2" style="color: #60a5fa !important;"></i> Emissão automática das guias de liquidação INSS</li>
                                <li class="mb-3"><i class="fas fa-check text-primary me-2" style="color: #60a5fa !important;"></i> Mapa mensal de remunerações para a AGT</li>
                                <li class="mb-3"><i class="fas fa-check text-primary me-2" style="color: #60a5fa !important;"></i> Envio direto de recibos por e-mail aos funcionários</li>
                                <li class="mb-0"><i class="fas fa-check text-primary me-2" style="color: #60a5fa !important;"></i> Histórico de alterações e auditoria de salários</li>
                            </ul>
                        </div>
                    </div>
                </div>

...
<head>
    ...
    <title>Módulo Contabilidade PGC — Consulvolt Soluções</title>
    <meta name="description" content="Módulo de Contabilidade do ERP Consulvolt em Angola. Plano Geral de Contabilidade (PGC), diários de lançamentos, balancetes de verificação, balanço e mapa de ativos imobilizados.">
...
<body>
    ...
    <section class="hero-banner-page">
        <div class="container">
            <span class="badge bg-primary px-3 py-2 rounded-pill mb-3" style="background-color: #0058E6 !important; font-size: 0.85rem;"><i class="fas fa-book me-1"></i> Plano PGC Angolano</span>
            <h1 class="fw-extrabold display-4 mb-3 text-white">Contabilidade PGC</h1>
            <p class="lead text-slate-300 fs-5 mb-0" style="max-width: 750px;">
                Solução contabética alinhada com o Plano Geral de Contabilidade de Angola. Lançamentos nos diários, Balancete de Verificação e Demonstração de Resultados.
            </p>
        </div>
    </section>
    ...
    <section class="py-5" style="background: #ffffff;">
        <div class="container py-4">
            <div class="row g-5 align-items-center">
                <div class="col-lg-7">
                    <span class="text-primary fw-bold text-uppercase fs-8" style="color: #0058E6 !important;">Rigor Contabético</span>
                    <h2 class="fw-extrabold text-dark fs-2 mb-4 mt-2">Gestão Financeira & Balanço PGC</h2>
                    <p class="text-secondary fs-6 mb-4" style="line-height: 1.7;">
                        O módulo de <strong>Contabilidade PGC</strong> do ERP Consulvolt disponibiliza todas as ferramentas necessárias para contadores, auditores e diretores financeiros elaborarem a prestação de contas com máxima exatidão.
                    </p>

                    <div class="row g-4 mb-4">
                        <div class="col-sm-6">
                            <div class="p-3 bg-light rounded-3 border">
                                <h6 class="fw-bold text-dark mb-2"><i class="fas fa-sitemap text-primary me-2" style="color: #0058E6 !important;"></i> Plano PGC Pré-carregado</h6>
                                <p class="text-muted fs-7 mb-0">Contas estruturadas de Classe 1 a Classe 8 conforme decreto angolano.</p>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="p-3 bg-light rounded-3 border">
                                <h6 class="fw-bold text-dark mb-2"><i class="fas fa-book-open text-primary me-2" style="color: #0058E6 !important;"></i> Diários Contabéticos</h6>
                                <p class="text-muted fs-7 mb-0">Lançamentos automáticos a partir das faturas, recibos e notas de caixa.</p>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="p-3 bg-light rounded-3 border">
                                <h6 class="fw-bold text-dark mb-2"><i class="fas fa-table text-primary me-2" style="color: #0058E6 !important;"></i> Balancete de Verificação</h6>
                                <p class="text-muted fs-7 mb-0">Emissão em tempo real por período com filtro de contas de débito/crédito.</p>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="p-3 bg-light rounded-3 border">
                                <h6 class="fw-bold text-dark mb-2"><i class="fas fa-building text-primary me-2" style="color: #0058E6 !important;"></i> Mapa de Imobilizados</h6>
                                <p class="text-muted fs-7 mb-0">Depreciações automáticas e fichas de ativos fixos da empresa.</p>
                            </div>
                        </div>
                    </div>

                    <a href="{{ route('register') }}" class="btn btn-blue btn-lg px-4 py-3">
                        <i class="fas fa-rocket me-2"></i> Experimentar Módulo de Contabilidade
                    </a>
                </div>
                ...
                <div class="col-lg-5">
                    <div class="card border-0 shadow-lg overflow-hidden" style="border-radius: 20px;">
                        <div class="card-body p-4 text-white" style="background: #090d16;">
                            <h5 class="fw-bold mb-3">Relatórios Financeiros Emitidos</h5>
                            <ul class="list-unstyled fs-7 text-slate-300 mb-0">
                                <li class="mb-3"><i class="fas fa-check text-primary me-2" style="color: #60a5fa !important;"></i> Balanço Analítico e Sintético em PDF</li>
                                <li class="mb-3"><i class="fas fa-check text-primary me-2" style="color: #60a5fa !important;"></i> Demonstração de Resultados por Natureza</li>
                                <li class="mb-3"><i class="fas fa-check text-primary me-2" style="color: #60a5fa !important;"></i> Extratos de Contas Correntes de Terceiros</li>
                                <li class="mb-3"><i class="fas fa-check text-primary me-2" style="color: #60a5fa !important;"></i> Ficheiro SAF-T de Contabilidade</li>
                                <li class="mb-0"><i class="fas fa-check text-primary me-2" style="color: #60a5fa !important;"></i> Fecho e Abertura de Exercício Fiscal</li>
                            </ul>
                        </div>
                    </div>
                </div>

...
<head>
    ...
    <title>Módulo Vendas & POS Certificado AGT — Consulvolt Soluções</title>
    <meta name="description" content="Módulo de Vendas e POS Certificado pela AGT n.º 142/AGT/2019 do ERP Consulvolt em Angola. Emissão de Faturas FT, FR, OR, PP, NC, ND, GT com assinatura digital RSA e SAF-T AO.">
...
<body>
    ...
    <section class="hero-banner-page">
        <div class="container">
            <span class="badge bg-primary px-3 py-2 rounded-pill mb-3" style="background-color: #0058E6 !important; font-size: 0.85rem;"><i class="fas fa-certificate me-1"></i> Software Certificado n.º 142/AGT/2019</span>
            <h1 class="fw-extrabold display-4 mb-3 text-white">Vendas & POS Certificado AGT</h1>
            <p class="lead text-slate-300 fs-5 mb-0" style="max-width: 750px;">
                Faturação fiscal em segundos, gestão de ponto de venda (POS), numeração sequencial travada e exportação automática do ficheiro SAF-T AO XML.
            </p>
        </div>
    </section>

    <!-- 4. CONTEÚDO DETALHADO DO MÓDULO -->
    <section class="py-5" style="background: #ffffff;">
        <div class="container py-4">
            <div class="row g-5 align-items-center">
                <div class="col-lg-7">
                    <span class="text-primary fw-bold text-uppercase fs-8" style="color: #0058E6 !important;">Faturação Homologada</span>
                    <h2 class="fw-extrabold text-dark fs-2 mb-4 mt-2">Gestão Completa de Vendas e Ponto de Venda</h2>
                    <p class="text-secondary fs-6 mb-4" style="line-height: 1.7;">
                        O módulo de <strong>Vendas & POS</strong> do ERP Consulvolt foi projetado especificamente para responder a todas as exigências legais e fiscais da <strong>Administração Geral Tributária (AGT)</strong> em Angola.
                    </p>
                    
                    <div class="row g-4 mb-4">
                        <div class="col-sm-6">
                            <div class="p-3 bg-light rounded-3 border">
                                <h6 class="fw-bold text-dark mb-2"><i class="fas fa-file-signature text-primary me-2" style="color: #0058E6 !important;"></i> Todos os Tipos Documentais</h6>
                                <p class="text-muted fs-7 mb-0">FT, FR, OR, PP, NC, ND e GT com assinatura digital RSA 1024-bit.</p>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="p-3 bg-light rounded-3 border">
                                <h6 class="fw-bold text-dark mb-2"><i class="fas fa-cash-register text-primary me-2" style="color: #0058E6 !important;"></i> POS Rápido de Balcão</h6>
                                <p class="text-muted fs-7 mb-0">Vendas diretas com abertura/fecho de caixa e impressão térmica.</p>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="p-3 bg-light rounded-3 border">
                                <h6 class="fw-bold text-dark mb-2"><i class="fas fa-file-code text-primary me-2" style="color: #0058E6 !important;"></i> Ficheiro SAF-T AO XML</h6>
                                <p class="text-muted fs-7 mb-0">Exportação com um clique para submissão mensal na AGT.</p>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="p-3 bg-light rounded-3 border">
                                <h6 class="fw-bold text-dark mb-2"><i class="fas fa-percent text-primary me-2" style="color: #0058E6 !important;"></i> Retenção na Fonte</h6>
                                <p class="text-muted fs-7 mb-0">Cálculo automático de retenções de imposto na emissão de faturas.</p>
                            </div>
                        </div>
                    </div>

                    <a href="{{ route('register') }}" class="btn btn-blue btn-lg px-4 py-3">
                        <i class="fas fa-rocket me-2"></i> Experimentar Módulo de Vendas
                    </a>
                </div>
                ...
                <div class="col-lg-5">
                    <div class="card border-0 shadow-lg overflow-hidden" style="border-radius: 20px;">
                        <div class="card-body p-4 text-white" style="background: #090d16;">
                            <h5 class="fw-bold mb-3">Destaques Fiscais AGT</h5>
                            <ul class="list-unstyled fs-7 text-slate-300 mb-0">
                                <li class="mb-3"><i class="fas fa-check text-primary me-2" style="color: #60a5fa !important;"></i> Número de Certificado: <strong>142/AGT/2019</strong></li>
                                <li class="mb-3"><i class="fas fa-check text-primary me-2" style="color: #60a5fa !important;"></i> Encriptação Hash de validação travada</li>
                                <li class="mb-3"><i class="fas fa-check text-primary me-2" style="color: #60a5fa !important;"></i> Séries Documentais por ano e estabelecimento</li>
                                <li class="mb-3"><i class="fas fa-check text-primary me-2" style="color: #60a5fa !important;"></i> Suporte para Imposto de Selo e IVA</li>
                                <li class="mb-0"><i class="fas fa-check text-primary me-2" style="color: #60a5fa !important;"></i> Validação automática de NIF angolano</li>
                            </ul>
                        </div>
                    </div>
                </div>

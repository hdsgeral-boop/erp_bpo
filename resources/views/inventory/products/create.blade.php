            ...
            <div class="col-md-8">
                <div class="card-premium p-4 mb-4">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-4">
                            <label class="form-label">Código / Referência <span class="text-muted small font-normal">(Opcional - Auto)</span></label>
                            <input type="text" name="code" class="form-control font-monospace text-uppercase" placeholder="Auto (ex: PRD-0001)" value="{{ old('code') }}">
                        </div>
                        <div class="col-md-8">

...
<div class="container-fluid py-4">
    <div class="mb-4">
        ...
        <h2 class="fw-bold mb-0 text-dark"><i class="fas fa-plus-square text-primary me-2"></i>Novo Cargo</h2>
        <p class="text-muted mb-0">Criar um novo cargo no sistema.</p>
    </div>
    ...
    <div class="card-premium p-4 p-md-5">
        <form action="{{ route('config.positions.store') }}" method="POST">
            @csrf
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="code" class="form-control" value="{{ old('code') }}" required placeholder="Ex: CRG-001">
                    </div>
                    
                    <div class="mb-3">
                        <label class="form-label">Título do Cargo <span class="text-danger">*</span></label>
                        <input type="text" name="title" class="form-control" value="{{ old('title') }}" required placeholder="Ex: Diretor Financeiro">
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Descrição das Funções</label>
                        <textarea name="description" class="form-control" rows="3" placeholder="Descreva as responsabilidades principais...">{{ old('description') }}</textarea>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        <div class="form-check form-switch mt-4">
                            <input class="form-check-input" type="checkbox" role="switch" name="is_management" id="is_management" {{ old('is_management') ? 'checked' : '' }} value="1">
            ...
            <div class="d-flex justify-content-end gap-3 mt-5 border-top pt-4">
                ...
                <button type="submit" class="btn btn-save"><i class="fas fa-save me-2"></i> Criar Cargo</button>
            </div>
        </form>
    </div>
</div>

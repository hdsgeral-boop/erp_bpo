...
<div class="container-fluid py-4">
    <div class="mb-4">
        ...
        <h2 class="fw-bold mb-0 text-dark"><i class="fas fa-edit text-primary me-2"></i>Editar Departamento</h2>
        <p class="text-muted mb-0">Atualize as definições de {{ $department->name }}.</p>
    </div>
    ...
    <div class="card-premium p-4 p-md-5">
        <form action="{{ route('config.departments.update', $department->id) }}" method="POST">
            @csrf
            @method('PUT')

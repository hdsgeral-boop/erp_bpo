...
<div class="container-fluid py-4">
    <div class="mb-4">
        ...
        <h2 class="fw-bold mb-0 text-dark"><i class="fas fa-user-plus text-primary me-2"></i>Novo Utilizador</h2>
    ...
    <div class="card-premium p-4 p-md-5">
        <form action="{{ route('admin.users.store') }}" method="POST">
            ...
            <div class="row g-5">
                    ...
                    <div class="row g-4">
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="name" class="form-control border-start-0" value="{{ old('name') }}" required placeholder="Ex: João Silva">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" name="email" class="form-control border-start-0" value="{{ old('email') }}" required placeholder="email@empresa.com">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="password" name="password" class="form-control border-start-0" required placeholder="Mínimo 8 caracteres">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-5">
                    ...
                    <div>
                        ...
                        <div class="check-list-container">
                            ...
                            <div class="form-check mb-2 pb-2 border-bottom">
                                <input class="form-check-input" type="checkbox" name="companies[]" value="{{ $comp->id }}" id="comp_{{ $comp->id }}" 
                                    {{ (is_array(old('companies')) && in_array($comp->id, old('companies'))) ? 'checked' : '' }}>
                        ...
                        <div class="form-text mt-2">Selecione as empresas às quais o utilizador pode aceder para lançamentos ou relatórios.</div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-end gap-3 mt-5 border-top pt-4">
                ...
                <button type="submit" class="btn btn-save"><i class="fas fa-save me-2"></i> Criar Utilizador</button>
            </div>
        </form>
    </div>
</div>

...
<div class="container-fluid py-4">
    <div class="mb-4">
        ...
        <h2 class="fw-bold mb-0 text-dark"><i class="fas fa-building text-primary me-2"></i>Nova Empresa</h2>
        <p class="text-muted mb-0">Adicione uma nova entidade empresarial ao sistema.</p>
    </div>
    ...
    <div class="card-premium p-4 p-md-5">
        <form action="{{ route('admin.companies.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-8">
                    <div class="row g-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="nif" class="form-control" value="{{ old('nif') }}" required placeholder="NIF da empresa">
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="province" class="form-control" value="{{ old('province') }}" placeholder="Ex: Luanda">
                        </div>
                        
                        <div class="col-md-4">
                            <label class="form-label">Município</label>
                            <input type="text" name="municipality" class="form-control" value="{{ old('municipality') }}" placeholder="Ex: Viana">
                        </div>
                        
                        <div class="col-md-4">
                            <label class="form-label">Comuna</label>
                            <input type="text" name="commune" class="form-control" value="{{ old('commune') }}" placeholder="Ex: Zango">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="p-4 bg-light rounded" style="border: 1px dashed #cbd5e1;">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text mt-2 text-muted" style="font-size: 0.8rem;">Formatos aceites: JPG, PNG. Max: 2MB.</div>
                        </div>
                        <div id="logo-preview" class="text-center mt-3 d-none">
                            <img src="" alt="Preview" class="img-fluid rounded shadow-sm" style="max-height: 120px;">
                        </div>
                    </div>

                    <div class="p-4 bg-light rounded mt-3" style="border: 1px solid #cbd5e1;">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" role="switch" id="is_master_data" name="is_master_data" value="1" {{ old('is_master_data') ? 'checked' : '' }}>
            ...
            <div class="d-flex justify-content-end gap-3 mt-5 border-top pt-4">
                ...
                <button type="submit" class="btn btn-save"><i class="fas fa-save me-2"></i> Guardar Empresa</button>
            </div>
        </form>
    </div>
</div>

    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 style="margin: 0; font-weight: 800; color: #0f172a; font-size: 1.6rem; letter-spacing: -0.5px;">
                <i class="fas fa-edit text-primary me-2"></i> Editar Escalão de IRT
            </h2>
        </div>
        ...
        <div class="card-body p-4">
            <form action="{{ route('rh.escaloes-irt.index') }}" method="GET">
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" class="form-control" value="100001.00" required>
                </div>
                <div class="mb-3">
                    <label class="form-label fw-bold">Limite Máximo (Kz)</label>
                    <input type="number" step="0.01" class="form-control" value="150000.00" required>
                </div>
                <div class="mb-3">
                    <label class="form-label fw-bold">Taxa Marginal (%)</label>
                    <input type="number" step="0.01" class="form-control" value="13.00" required>
                </div>
                <button type="submit" class="btn btn-primary fw-bold" style="border-radius: 10px;">Atualizar Escalão</button>
            </form>
        </div>
    </div>
</div>

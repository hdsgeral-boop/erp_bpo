    ...
    <div class="d-flex justify-content-between align-items-center mb-4" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem;">
        <div>
            ...
            <p style="margin: 0; color: #64748b; font-size: 0.9rem;">
                Registo e aprovação de trabalho suplementar (50%, 100% LGT Angola).
            </p>
        </div>
        <div>
            <button class="btn btn-primary" style="padding: 0.6rem 1.2rem; background: #2563eb; color: #fff; border: none; border-radius: 8px; font-weight: 600; cursor: pointer;">
                <i class="fas fa-plus me-1"></i> Registar Horas Extras
            </button>
        </div>
    </div>
        ...
        <table style="width: 100%; border-collapse: collapse; text-align: left;">
            <thead>
                <tr style="border-bottom: 2px solid #e2e8f0; background: #f8fafc;">
                    ...
                    <th style="padding: 0.75rem 1rem; font-size: 0.85rem; color: #475569; text-transform: uppercase;">Horas Realizadas</th>
                    <th style="padding: 0.75rem 1rem; font-size: 0.85rem; color: #475569; text-transform: uppercase;">Taxa LGT</th>
                    <th style="padding: 0.75rem 1rem; font-size: 0.85rem; color: #475569; text-transform: uppercase;">Valor Calculado</th>
            ...
            <tbody>
                <tr style="border-bottom: 1px solid #f1f5f9;">
                    ...
                    <td style="padding: 1rem; font-weight: 700;">4 Horas</td>
                    <td style="padding: 1rem; font-weight: 600; color: #2563eb;">50% (Dia Útil)</td>
                    <td style="padding: 1rem; font-weight: 700; color: #16a34a;">25.000,00 Kz</td>
                    <td style="padding: 1rem;"><span style="background: #dcfce7; color: #166534; padding: 0.25rem 0.6rem; border-radius: 4px; font-weight: 600; font-size: 0.75rem;">VALIDADO</span></td>
                </tr>
            </tbody>
        </table>
    </div>
